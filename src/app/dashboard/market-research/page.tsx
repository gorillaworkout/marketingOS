  ...
  return (
    <PageStack>
      ...
      <Panel>
        ...
        <div className="mt-4"><p className="text-xs font-semibold uppercase tracking-wider text-[var(--mos-text-faint)]">Product groups selalu dipindai</p><div className="mt-2 flex flex-wrap gap-2">{['Forex', 'Commodity', 'US Indices', 'US Stocks'].map(group => <StatusBadge key={group}>{group}</StatusBadge>)}</div></div>
