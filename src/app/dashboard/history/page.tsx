                    ...
                    if (selected.type === 'event-plan') {
                      ...
                      return (
                        <>
                          ...
                          <div><label className="text-xs text-[var(--mos-text-faint)] uppercase tracking-wide">📍 Venue / location</label><p className="text-[var(--mos-text-secondary)] mt-1 bg-[var(--mos-raised)] p-3 rounded-lg">{plan.venue || 'Venue not specified — confirm city and venue name'}</p></div>
