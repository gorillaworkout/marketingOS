  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">🏷️ Brand Guidelines</h1>
          <p className="text-gray-400 mt-1">Define brand voice, tone, and rules for AI-generated content</p>
        </div>
