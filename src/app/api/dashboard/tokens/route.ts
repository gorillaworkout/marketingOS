...
export async function GET(request: NextRequest) {
  ...
  const logs = db.prepare('SELECT id, model, input_tokens, output_tokens, cost, created_at FROM token_logs ORDER BY created_at DESC LIMIT 50').all() as Record<string, unknown>[];
